...
int main(void)
{
	int aBunchOfInts[ARRAY_SIZE] = {9,2,3,5,4,2,56,-12,-80,10};
    int (*function_ptr[4])(int,int) = { low_to_high_compare, high_to_low_compare, absolute_low_to_high_compare, absolute_high_to_low_compare };

    bubble_sort(aBunchOfInts,ARRAY_SIZE, *function_ptr);
